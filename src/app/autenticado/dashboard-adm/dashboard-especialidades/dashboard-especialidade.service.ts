...
@Injectable()
export class DashboardEspecialidadeService {
  constructor(private httpClient:HttpClient) { }

  public getList(input: FilteredInput): Observable<PagedResult<EspecialidadeModel>> {
    ...
    return this.httpClient.get<PagedResult<EspecialidadeModel>>(this.basePath, { params });
  }
